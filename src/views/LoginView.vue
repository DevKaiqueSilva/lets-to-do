			...
			<v-card class="login-area" elevation="5">
				...
				<v-form :disabled="loading" ref="refFormLogin" @submit.prevent="()=>{}">
					...
					<v-text-field
						...
						:type="showPassword ? 'text' : 'password'" id="password-input"
				...
				<v-btn
					v-if="loginSuccessful==false" block color="color3" 
					:disabled="loading" :loading="loading" id="login-button"
				...
				<v-layout v-else justify-center align-center>
					<v-avatar id="success-login" class="mx-auto mt-4 login-success" size="70" color="green">
